Task 0 - Writes a script that prints “Hello, World”, followed by a new line to the standard output.
...
Task 14 - Display lines containing the pattern “root” from the fil -e /etc/passwd
...
Task 19 - Replace all characters A and c from input to Z anTask 22 - Write a script that displays all users and their home directories, sorted by users.
